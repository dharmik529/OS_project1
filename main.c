...
int run_producer_consumer_example() {
  initialize_sems();
...
int main() {
  ...
  while (1) {
    ...
    printf("2. Create a thread\n");
    printf("3. Terminate a thread\n");
    printf("4. Monitor all running processes on your device.\n");
    printf("5. Send IPC message\n");
    printf("6. Receive IPC message\n");
    printf("7. Clear log file\n");
    printf("8. Process Synchronization (Producer-Consumer)\n");
    printf("9. Exit\n");
    ...
    if (choice[0] == '1') {
      ...
      printf("Enter the thread name: ");
      scanf("%s", thread_name);
      create_thread(thread_name);
      printf("\n");
    } else if (choice[0] == '3') {
      char thread_name_to_terminate[100];
      printf("Enter thread name to terminate: ");
      scanf("%s", thread_name_to_terminate);
      terminate_thread(thread_name_to_terminate);
      printf("\n");
    } else if (choice[0] == '4') {
      list_processes();
      printf("\n");
      ...
      const char *received_message = ipc_recieve_message();
      printf("\n");
      if (received_message) {
